        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-content">
                    <% try{ List<Photo> photos = (List<Photo>) request.getAttribute("listPhotos");
                            //System.out.println(photos.size());
                            DatabaseCrud dao = new DatabaseCrud();
                            %>
                            <form action="DeleteImageServlet" method="post">
                                <p class="w3-large">
                                    Wanna delete an image? ----> Type the image id here: <input type="number" name="id">
                            ...
                            <table border="0" cellpadding="5">
                                ...
                                <% for (int i=0; i < photos.size(); i +=1) { %>
                                    <tr>
                                        <td>
                                            <div class="thumbnail">
                                                <img src="data:image/jpg;base64,<%=photos.get(i).getBase64Image()%>">
                                            </div>
                                        </td>
                                        <td>
                                            <p class="w3-large">
                                        ...
                                        <td><a href="data:image/png;base64,<%=photos.get(i).getBase64Image()%>" download="<%=photos.get(i).getTitle()%>.png"><button>Download</button></a>
                                        </td>
                                    </tr>
                                    <% } %>
                            </table>
