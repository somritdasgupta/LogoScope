...
@WebServlet ("/Bold")
public class Bold extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Photo> photos = null;
			photos = dao.listMatchingTagPhoto("Bold");
			request.setAttribute("listPhotos", photos);
			request.getRequestDispatcher("ImageCategories/Bold.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
