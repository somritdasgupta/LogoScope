package ImageCategoriesServlets;
...
@WebServlet ("/BlackAndWhite")
public class BlackAndWhite extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Photo> photos = null;
			photos = dao.listMatchingTagPhoto("Black And White");
			request.setAttribute("listPhotos", photos);
			request.getRequestDispatcher("ImageCategories/BlackAndWhite.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
