...
@WebServlet("/Alphabets")
public class Alphabets extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Photo> photos = null;
			photos = dao.listMatchingTagPhoto("Alphabets");
			request.setAttribute("listPhotos", photos);
			request.getRequestDispatcher("ImageCategories/Alphabets.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
